...
export const Register: React.FC = () => {
  ...
  return (
    <>
      <HelmetSeo
        title="RunRando - Inscription"
        description="Rejoignez la communauté RunRando et profitez de tous nos services en créant votre compte en ligne en quelques cliques !"
        path="/inscription"
      />
